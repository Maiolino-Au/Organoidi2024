# in questo file non c'è ancora il punto 1
...
jpeg(paste(name_new_dir_1,"/Violin_SRCIN1_ACTB_",timepoints[y],".jpg",sep=""),width=960, height=540)
print(violin)
dev.off()
...
jpeg(paste(name_new_dir_1,"/Ratio_SRCIN1_ACTB_",timepoints[y],".jpg",sep=""),width=960, height=540)
print(ratio)
dev.off()
...
summary(FetchData(sc_data, vars = "SRCIN1"))
summary(GetAssayData(sc_data, layer = "counts")["SRCIN1", ])
